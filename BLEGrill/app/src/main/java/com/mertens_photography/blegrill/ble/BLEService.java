...
public class BLEService extends Service {
	...
	public final static UUID UUID_BLE_GRILL_UART_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_Uart_Service);
	public final static UUID UUID_BLE_GRILL_UART_TX = UUID
			.fromString(BLEGattAttributes.BLE_Grill_Uart_TX);
	public final static UUID UUID_BLE_GRILL_UART_RX = UUID
			.fromString(BLEGattAttributes.BLE_Grill_Uart_RX);

	/* Temperature Sensor 1 */
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR1_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor1_Service);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR1_ALARM = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor1_Alarm_Settings);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR1_CONFIG = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor1_Sensor_Config);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR1_MEASURE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor1_Temp_Measurement);

		/* Temperature Sensor 2 */
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR2_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor2_Service);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR2_ALARM = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor2_Alarm_Settings);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR2_CONFIG = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor2_Sensor_Config);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR2_MEASURE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor2_Temp_Measurement);

	/* Temperature Sensor 3 */
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR3_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor3_Service);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR3_ALARM = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor3_Alarm_Settings);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR3_CONFIG = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor3_Sensor_Config);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR3_MEASURE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor3_Temp_Measurement);

	/* Temperature Sensor 4 */
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR4_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor4_Service);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR4_ALARM = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor4_Alarm_Settings);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR4_CONFIG = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor4_Sensor_Config);
	public final static UUID UUID_BLE_GRILL_TEMPSENSOR4_MEASURE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_TempSensor4_Temp_Measurement);

	/* Device Settings */
	public final static UUID UUID_BLE_GRILL_DEVICE_SETTING_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_DeviceSettings_Service);
	public final static UUID UUID_BLE_GRILL_HARDWARE_STATES = UUID
			.fromString(BLEGattAttributes.BLE_Grill_DeviceSettings_HardwarStates);
	public final static UUID UUID_BLE_GRILL_MEASURE_INTERVALL = UUID
			.fromString(BLEGattAttributes.BLE_Grill_DeviceSettings_MeasureIntervall);
	public final static UUID UUID_BLE_GRILL_NOTIFY_INTERVALL = UUID
			.fromString(BLEGattAttributes.BLE_Grill_DeviceSettings_NotifyIntervall);

	/* Alarm Notifier */
	public final static UUID UUID_BLE_GRILL_ALARM_NOTIFIER_SERVICE = UUID
			.fromString(BLEGattAttributes.BLE_Grill_AlarmNotifier_Service);
	public final static UUID UUID_BLE_GRILL_ALARM_INDICATION = UUID
			.fromString(BLEGattAttributes.BLE_Grill_AlarmNotifier_Indication);
	public final static UUID UUID_BLE_GRILL_QUITT_ALARM = UUID
			.fromString(BLEGattAttributes.BLE_Grill_AlarmNotifier_QuitAlarm);
	...
	public void setCharacteristicNotification(
		...
		BluetoothGattDescriptor descriptor = characteristic
				.getDescriptor(UUID
						.fromString(BLEGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
		descriptor
