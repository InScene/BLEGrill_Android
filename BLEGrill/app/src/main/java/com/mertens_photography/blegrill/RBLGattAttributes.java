...
public class RBLGattAttributes {
	...
	static {
		...
		/* RBL TemperatureSensor1 Services. */
		attributes.put(BLE_Grill_TempSensor1_Service, "Temperature Sensor1");
		/* RBL TemperatureSensor1 Characteristics. */
